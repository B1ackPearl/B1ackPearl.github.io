...
1. Сделать [макет](/Frontend_GoIT/HTML/Lesson_07-08/homework7-8.zip) с 7-8 домашки кроссбраузерным. Пиксельную точность на все браузеры делать не нужно, только для последнего хрома
